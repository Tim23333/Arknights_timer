...
def wave_timeline(waves):
    """Flatten waves into absolute spawn/action events (additive model)."""
    events = []
    wave_t = 0.0
...
def main():
    ...
    bundle = {
        "meta": {
            ...
            "waveModel": "additive: t = wave.preDelay + fragment.preDelay + "
                         "action.preDelay; spawns at t + i*interval; "
                         "see 10_level_schema_calibration.md",
        },
        "levels": levels,
        "enemyRoster": roster,
        "stages": stage_map,
