...
class MonitorStateTests(unittest.TestCase):
    def test_default_runtime_storage_is_under_user_data_root(self):
        self.assertEqual(DEFAULT_OUTPUT_DIR.name, "websocket-monitor")
    ...
    def test_rng_address_is_exposed_as_a_monitor_warning(self):
        ...
        self.assertTrue(_contains_internal_address({"time_address": "hidden"}))
